...
describe "::Libsql::SQLite3::Version" do
  it "should have the sqlite3 version" do
    ...
    ::Libsql::SQLite3::Version.to_i.should eql(3041002)
    ::Libsql::SQLite3::Version.runtime_version_number.should eql(3041002)

    ::Libsql::SQLite3::Version::MAJOR.should eql(3)
    ::Libsql::SQLite3::Version::MINOR.should eql(41)
    ::Libsql::SQLite3::Version::RELEASE.should eql(2)
    expect(::Libsql::SQLite3::Version.to_a.size).to eql(3)

    ::Libsql::SQLite3::Version.compiled_version.should be == "3.41.2"
    ::Libsql::SQLite3::Version.compiled_version_number.should be == 3041002
